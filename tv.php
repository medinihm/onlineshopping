            ...
            <p> TV Consoles </p>
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/t1.jpeg" alt="tv">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Modern Wood Table</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/t2.jpeg" alt="dining table">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>New Stylish Table</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/t3.jpeg" alt="dining table">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Simple Down Table</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/t4.jpeg" alt="dining table">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Wooden Table</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                            <img src="img/t5.jpeg" alt="dining table">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Old Style White Table</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/t6.jpeg" alt="dining table">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>White Wooden Table</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/t7.jpeg" alt="dining table">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Wooden Shelf Console</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/t8.jpeg" alt="dining table">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Black Wall Attached Console</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/t9.jpeg" alt="dining table">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Wooden Down Console </h3>
                                    <p>Price: Rs. 5000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/t10.jpeg" alt="dining table">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Wooden storage console</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/t11.jpeg" alt="dining table">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Black Wooden Console</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/t12.jpeg" alt="dining table">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Modern Wooden Table</h3>
                                    <p>Price: Rs. 21200.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
