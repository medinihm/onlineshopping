            ...
            <p> Wardrobe</p> 
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/wr1.jpeg" alt="wardrobe">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Glass Wardrobe</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/wr2.jpeg" alt="wardrobe">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Wall Attached Wardrobe</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/wr3.jpg" alt="wardrobe">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>2 Door Wardrobe</h3>
                                    <p>Price: Rs. 35000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/wr4.jpeg" alt="wardrobe">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Drawer Along With Door Wardrobe</h3>
                ...
                <p> Wardrobes</p>
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/w1.jpg" alt="wardrobe">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/w2.jpg" alt="cupboard">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Wardrobe with Mirror</h3>
                                    <p>Price: Rs. 25000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/w3.JPG" alt="wardrobe">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Double Door Wardrobe</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/w4.jpg" alt="cupboard">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>4 Door cupboard</h3>
                                    <p>Price: Rs. 18000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/wr5.jpeg" alt="wardrobe">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>4 Door Wardrobe </h3>
                                    <p>Price: Rs. 30500.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/wr6.jpeg" alt="wardrobe">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Glass Door Wardrobe</h3>
                                    <p>Price: Rs. 30000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/wr7.jpeg" alt="wardrobe">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>New White Wrdrobe</h3>
                                    <p>Price: Rs. 18900.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/wr8.jpeg" alt="wardrobe">
                            </a>
                            <center>
                                <div class="caption">
