            ...
            <p> Show Pieces </p>
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/p2.jpeg" alt="dining table">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Artificial Bonsai Tree</h3>
                                    <p>Price: Rs. 299.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/p3.jpeg" alt="dining table">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3> Metallic Hanging</h3>
                                    <p>Price: Rs. 799.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/p4.jpeg" alt="dining table">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3> Tree Handicraft</h3>
                                    <p>Price: Rs. 420.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                            <img src="img/p5.jpeg" alt="dining table">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Wall Clock</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/p6.jpeg" alt="dining table">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Trendy Cage</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/p7.jpeg" alt="dining table">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/p8.jpeg" alt="dining table">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3> Set of 2 Owls</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/p9.jpeg" alt="dining table">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Copper Gramaphone </h3>
                                    <p>Price: Rs. 999.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/p10.jpeg" alt="dining table">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Crystal Tree</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/p11.jpeg" alt="dining table">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Budha Idol</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/p12.jpeg" alt="dining table">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Bonsai Tree</h3>
