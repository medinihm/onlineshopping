            ...
            <p> Dining Tables</p>
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/d2.jpg" alt="Sony DSLR">
                            </a>
                            <center>
                                <div class="caption">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/s1.jpg" alt="sofa">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Mistana sofa set </h3>
